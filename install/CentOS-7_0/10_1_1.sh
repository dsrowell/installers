...
if grep -q "Order allow,deny" /etc/zpanel/panel/modules/apache_admin/hooks/OnDaemonRun.hook.php; then sed -i 's|Order allow,deny|Require all granted|' /etc/zpanel/panel/modules/apache_admin/hooks/OnDaemonRun.hook.php; fi
